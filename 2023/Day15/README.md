...
Run the HASH algorithm on each step in the initialization sequence. **What is the sum of the results?** _(The initialization sequence is one long line; be careful when copy-pasting it.)_
